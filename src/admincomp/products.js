...
const Categories = () => {
  ...
  return (
    <div className='container'>
      ...
      <Link to="/admin/product" className='btn btn-primary'>Add Product</Link><br /><br />
      </div>
        ...
        </tr>
        {
          datas.map((data)=>{
            return(
              ...
              <tr>
                <td>
                <Link className="btn btn-primary " to={"/admin/product/" + data._id }>Edit</Link>
                ...
                <td>
                  <Link className='btn btn-warning' to={"/product/varieties/" + data._id }>{data.varieties.length}</Link>
                </td>
